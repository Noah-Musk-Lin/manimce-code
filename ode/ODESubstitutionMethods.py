...
class ODESubstitutionMethods(Scene):
    def construct(self):
        # 开场标题 - 使用渐变效果
        ...
        self.play(Write(formula3))  # 替换 DrawBorderThenFill
        self.wait(1)
        ...
        center_y = formula5.get_center()[1]
        arrow_group.next_to(formula5, RIGHT, buff=0.5)
        arrow_group.move_to([arrow_group.get_center()[0], center_y, 0])
        self.play(Create(arrow))  # 替换 GrowArrow
        self.play(FadeIn(arrow_top_text, shift=DOWN), FadeIn(arrow_bottom_text, shift=UP))
        self.wait(2)
        ...
        # 替换 Flash 效果
        self.play(Indicate(text7, color=BLUE, scale_factor=1.05))
        self.play(Write(text7))
        self.wait(2)
        
        # 过渡到应用部分 - 使用缩放效果
        self.play(
            *[FadeOut(mob, shift=DOWN) for mob in [Text2, formula0, Text3, group1, group2, formula5, arrow_group, formula2_right, text7]]
        )
        self.wait(1)

        text8 = Text("下面来运用换元解决常见的6种常微分方程", font="SimHei", font_size=35,color = YELLOW_A).to_edge(UP*2.5)
        self.play(Write(text8))  # 替换 ScaleInFromCenter
        self.wait(1)
        self.play(FadeOut(text8, shift=UP))
        self.wait(0.5)
        
        # 1. 一阶齐次方程 - 使用滑入效果
        text9 = Text("1.一阶齐次方程", font="SimHei", font_size=30,color = WHITE).to_edge(LEFT).shift(UP*2)
        self.play(FadeIn(text9, shift=LEFT))  # 替换 Slide
        self.wait(0.5)
        ...
        self.play(FadeIn(group4, shift=RIGHT))
        self.wait(1)
        ...
        self.play(AnimationGroup(
            FadeIn(text11, shift=UP),
            FadeIn(formula8, shift=DOWN),
            lag_ratio=0.5
        ))
        self.wait(0.5)
        ...
        self.play(Write(formula10))  # 替换 GrowFromCenter
        self.wait(0.5)
        ...
        self.play(Create(single_arrow))  # 替换 GrowArrow
        self.wait(0.5)
        ...
        self.play(FadeIn(group6, shift=LEFT))
        self.wait(2)
        
        # 淡出第一类方程
        self.play(
            *[FadeOut(mob, shift=DOWN) for mob in [text9, formula6, group4, group5, vertical_group, single_arrow, formula10, formula11, group6]]
        )
        
        # 2. 伯努利方程 - 使用旋转效果
        text14 = Text("2.伯努利(Bernoulli)方程", font="SimHei", font_size=30, color=WHITE).to_edge(LEFT).shift(UP*2)
        self.play(FadeIn(text14, shift=UP))  # 替换 RotateIn
        self.wait(0.5)
        ...
        self.play(Write(group7))  # 替换 SpinInFromNothing
        self.wait(1)
        ...
        self.play(Write(group8))  # 替换 DrawBorderThenFill
        self.wait(0.5)
        ...
        self.play(TransformMatchingShapes(formula14.copy(), formula15))
        self.wait(0.5)
        ...
        self.play(FadeIn(text17, shift=UP))
        self.wait(0.5)
        ...
        self.play(AnimationGroup(
            FadeIn(text19, shift=RIGHT),
            FadeIn(general_solution_bern, shift=LEFT),
            lag_ratio=0.3
        ))
        self.wait(2)
        ...
        # 淡出伯努利方程
        self.play(
            *[FadeOut(mob, shift=UP) for mob in [text14, formula12, group7, group8, formula15, text17, formula16, single_arrow2, text18, group9]]
        )
        
        # 3. 可化为齐次的方程 - 使用波浪效果
        text20 = Text("3.可化为齐次的方程（含常数项的线性分式型）", font="SimHei", font_size=30, color=WHITE).to_edge(LEFT).shift(UP*2)
        # 替换 Wiggle 效果
        self.play(Indicate(text20, color=YELLOW, scale_factor=1.05))
        self.wait(0.5)
        ...
        self.play(FadeIn(group10, shift=DOWN))
        self.wait(0.5)
        ...
        self.play(Write(transform_formula))  # 替换 GrowFromCenter
        self.wait(0.5)
        ...
        self.play(FadeIn(system_text, shift=LEFT))
        self.wait(0.5)
        ...
        self.play(Write(system_eq))  # 替换 DrawBorderThenFill
        self.wait(0.5)
        ...
        self.play(FadeIn(text24, shift=UP))
        self.wait(0.5)
        ...
        # 淡出情况1的内容，保留大标题和方程形式
        self.play(
            *[FadeOut(mob, shift=DOWN) for mob in [text22, determinant_formula, text23, transform_formula, system_text, system_eq, text24, homogeneous_eq]]
        )
        self.wait(0.5)
        ...
        self.play(FadeIn(text25, shift=RIGHT))  # 替换 Slide
        self.wait(0.5)
        ...
        self.play(
            *[FadeOut(mob, shift=LEFT) for mob in [text20, formula17, group10, text25, zero_determinant, group11, text27, separable_eq]]
        )
        
        # 4. 形如dy/dx = f(ax+by+c)的方程 - 使用组合动画
        ...
        self.play(AnimationGroup(
            FadeIn(text28, shift=LEFT),
            Write(formula18),  # 替换 GrowFromCenter
            FadeIn(text28_end, shift=RIGHT),
            lag_ratio=0.3
        ))
        self.wait(1)
        ...
        self.play(Write(group12))  # 替换 SpinInFromNothing
        self.wait(0.5)
        ...
        self.play(Write(group13))  # 替换 DrawBorderThenFill
        self.wait(0.5)
        ...
        self.play(AnimationGroup(
            FadeIn(text34, shift=UP),
            FadeIn(general_solution, shift=DOWN),
            lag_ratio=0.5
        ))
        self.wait(2)

        self.play(
            *[FadeOut(mob, shift=UP) for mob in [text28, formula18, group12, group13, group14, formula21, text32, formula22, single_arrow3, formula23, text33, formula24, group15, title_group, text28_end]]
        )
        
        # 5. 高阶方程的降阶 - 使用波浪效果
        text35 = Text("5.高阶方程的降阶（通过换元降阶）", font="SimHei", font_size=30, color=WHITE).to_edge(LEFT).shift(UP*2)
        self.play(Indicate(text35, color=YELLOW, scale_factor=1.05))  # 替换 Wiggle
        self.wait(0.5)
        ...
        self.play(FadeIn(group16, shift=LEFT))
        self.wait(0.5)

        # 情况1:不显含未知函数y的二阶方程 - 使用打字机效果
        ...
        self.play(Write(formula25))  # 替换 SpinInFromNothing
        self.wait(0.5)
        ...
        self.play(AnimationGroup(
            FadeIn(text38, shift=UP),
            Write(formula26),  # 替换 GrowFromCenter
            FadeIn(text39, shift=DOWN),
            Write(formula27),
            lag_ratio=0.3
        ))
        self.wait(0.5)
        ...
        self.play(Write(group18))  # 替换 DrawBorderThenFill
        self.wait(0.5)
        ...
        self.play(FadeIn(group19, shift=RIGHT))
        self.wait(0.5)
        ...
        # 淡出情况1的内容，保留大标题和换元方法
        self.play(
            *[FadeOut(mob, shift=DOWN) for mob in [text37, formula25, group17, group18, group19, group20]]
        )
        self.wait(0.5)

        # 情况2:不显含自变量x的二阶方程 - 使用旋转效果
        ...
        self.play(FadeIn(text44, shift=UP))  # 替换 RotateIn
        self.wait(0.5)
        ...
        self.play(AnimationGroup(
            FadeIn(text45, shift=LEFT),
            Write(formula33),  # 替换 SpinInFromNothing
            FadeIn(text46, shift=RIGHT),
            Write(formula34),
            lag_ratio=0.3
        ))
        self.wait(0.5)
        ...
        self.play(TransformMatchingShapes(formula34.copy(), formula35))
        self.wait(0.5)
        ...
        self.play(FadeIn(group23, shift=UP))
        self.wait(0.5)
        ...
        # 结尾 - 使用强调效果
        self.play(
            *[FadeOut(mob, shift=UP) for mob in [text35, group16, text44, formula32, group21, group22, group23, group24, Text1]]
        )
        
        end_text = Text("掌握换元法，解决微分方程更轻松！", font="SimHei", font_size=35, color=GREEN)
        self.play(Indicate(end_text, color=GREEN, scale_factor=1.1))  # 替换 Flash
